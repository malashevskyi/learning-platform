...
const SelectTrigger = ({
  ...
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9  items-center justify-between whitespace-nowrap rounded-md border border-input bg-transparent px-3 py-2 text-sm shadow-sm ring-offset-background data-[placeholder]:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50",
      className
    )}
    {...props}
  >
...
const SelectLabel = ({ className, ref, ...props }: LabelProps) => (
...
const SelectItem = ({ className, children, ref, ...props }: ItemProps) => (
...
const SelectSeparator = ({ className, ref, ...props }: SeparatorProps) => (
